...
This module provides comprehensive control for Allen & Heath dLive digital mixing consoles via MIDI over TCP/IP.
...
- **Assign Mute Groups for Channel** - Assign input channels to multiple mute groups
...
For technical support and feature requests, please visit the [GitHub repository](https://github.com/shedworth/companion-module-allenheath-dlive-ilive.git).
