...
import { camelCase, noop, times } from 'lodash/fp'
...
import { getMidiOffsetsForChannelType } from '../../src/utils/getMidiOffsetsForChannelType.js'
...
describe('muteOn', () => {
	...
	describe.each(testCases)('should mute %s', (channelType, channelCount) => {
		it.each(times((index: number) => index + 1)(channelCount))('%s', (channelNo: number) => {
